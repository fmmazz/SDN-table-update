...
class FirstExperiment(app_manager.RyuApp):
	...
	def send_flow_mod(self, datapath):
		...
		match = ofp_parser.OFPMatch(in_port=1, eth_type=0x800)
		actions = []
		...
		if initial_rules != 0:
			for k in xrange(initial_rules, 0, -1):
				...
				if k == initial_rules:
					ipv4_dst_first = dst
				new_priority = 65535
				match = ofp_parser.OFPMatch(eth_type=0x800, ip_proto=17,in_port=1,ipv4_src=ipv4_src,ipv4_dst=dst,ip_dscp=0,udp_src=38388,udp_dst= 45678)
